...
struct KeyFinder {
    ...
    func run(){
        ...
        do {
            ...
            correct = res[2].toCompressed().hex == "02f9308a019258c31049344f85f89d5229b531c845836f99b08601f113bce036f9"
            print("\(correct) Expected: 02f9308a019258c31049344f85f89d5229b531c845836f99b08601f113bce036f9 \n        Actual: \(res[2].toCompressed().hex)" )
            
            correct = res[3].toCompressed().hex == "0206a7d89b595868e231e3474a37051185a8c4d344f02edd122258fb355cfd6000"
            print("\(correct) Expected: 0206a7d89b595868e231e3474a37051185a8c4d344f02edd122258fb355cfd6000 \n        Actual: \(res[3].toCompressed().hex)" )
            
            // uncompressed
            correct = res[3].toUncompressed().hex == "0406a7d89b595868e231e3474a37051185a8c4d344f02edd122258fb355cfd6000f50b6b9828f3d11e65825bf2f26fc735817eda1e7b601849292848980b3281de"
